...
<div class="container post-container">
  ...
  <form:form method="post" action="changepassword"
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4 col-sm-5 col-6">
        <form:input type="password" path="oldPassword"
          value="${password.oldPassword}" class="form-control" />
      </div>
      <div class="col-md-6 col-sm-4 col-12">
        <small><form:errors class="text-danger"
            path="oldPassword" /></small> <small class="text-danger">${invalidPassword}</small>
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4 col-sm-5 col-6">
        <form:input type="password" value="${password.newPassword}"
          path="newPassword" class="form-control" />
      </div>
      <div class="col-md-6 col-sm-4 col-12">
        <small><form:errors class="text-danger"
            path="newPassword" /></small> <small class="text-danger">${passwordMismatchError}</small>
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-4 col-sm-5 col-6">
        <form:input type="password" value="${confirmNewPassword}"
          path="confirmNewPassword" class="form-control" />
      </div>
