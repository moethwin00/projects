...
<div class="container post-container">
  <h5 class="h5 mb-3">Create User Confirmation</h5>
  <form:form method="post" action="insertUser" modelAttribute="user">
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row mb-1">
          ...
          <div class="col-md-8">
            <form:input
              ...
              type="password" value="${user.password}" path="password"
              disabled="true" />
        ...
        <div class="row mb-1">
          <div class="col-md-4">
            <label><span class="align-middle">Date of
                Birth</span></label>
          </div>
          <div class="col-md-8">
            <p>${user.dob}</p>
    ...
    <div class="row">
      <div class="col-md-4 text-right">
        <input type="submit" class="btn btn-primary"
          value="<c:if test='${user.id == 0}'>Create</c:if>
