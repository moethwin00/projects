		...
		<div class="container">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><a href="#" data-toggle="modal" data-target="#detailUser${user.id}">${user.name}</a></td>
						<td>${user.email}</td>
			...
			<c:forEach var="user" items="${userLists}" varStatus="looop">
				<div class="modal fade" id="confirmUserModal${user.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				  <div class="modal-dialog modal-dialog-centered" role="document">
				    <div class="modal-content">
				      ...
				      <div class="modal-footer bg-danger">
				        <button type="button" class="btn btn-primary" onclick="deleteUser(${user.id})">Yes</button>
				  ...
				  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
				    <div class="modal-content">
				     ...
				     <div class="modal-body">
				     	<p class="small font-weight-bold text-muted">Created by <span class="text-success">${user.name}</span> at <span class="text-primary">${user.createdAt}</span></p>
				     	<p class="small font-weight-bold text-muted">Updated by <span class="text-success">${user.name}</span> at <span class="text-primary">${user.updatedAt}</span></p>
			...
			<div class="container text-center <c:if test="${userCount <= 7}">close-pagination</c:if>">
