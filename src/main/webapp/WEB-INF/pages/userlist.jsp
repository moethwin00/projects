      ...
      <div class="row">
        ...
        <div class="col-md-2 mb-1 col-sm-6">
          <form:input type="date" class="form-control"
            path="createdFrom" value="${userSearch.createdFrom}" />
        </div>
        <div class="col-md-2 mb-1 col-sm-6">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p class="small font-weight-bold text-muted">
                  Created by <span class="text-success">${user.name}</span>
                  at <span class="text-primary">${user.createdAt}</span>
                </p>
                <p class="small font-weight-bold text-muted">
                  Updated by <span class="text-success">${user.name}</span>
                  at <span class="text-primary">${user.updatedAt}</span>
                </p>
